...
public class PlayerAnimator : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        {
            tiltProgress = Mathf.InverseLerp(-mov.movementData.runMaxSpeed, mov.movementData.runMaxSpeed, mov.RB.velocity.x);
        ...
        //jumpPSettings.startColor = new ParticleSystem.MinMaxGradient(demoManager.LevelData.foregroundColor);
        ParticleSystem.MainModule landPSettings = _landParticle.main;
        //landPSettings.startColor = new ParticleSystem.MinMaxGradient(demoManager.LevelData.foregroundColor);
    }
